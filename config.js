...
module.exports = {
  ...
  START_IMG: process.env.START_IMG || "https://i.ibb.co/CsswdCWx/shaban-md.jpg",
  CDN: process.env.CDN || "https://cdn-bandaheali.zone.id",
  AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN || "true",
  AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",
  AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT || "true",
  AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS JAMSHAID-MD*",
  ...
  BOT_NAME: process.env.BOT_NAME || "JAMSHAID-MD",
  STICKER_NAME: process.env.STICKER_NAME || "JAMSHAID-MD",
  ...
  ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/CsswdCWx/shaban-md.jpg",
